...
**Versão atual do plugin:** **v2.38.1** (atualizada em 2026-05-11 -- render-loop visual + hardening operacional + drift repair pos-v2.38.0)
**Modelo de referência:** `frank-juridico-ti-plugin/` (v1.5.3)

> NOTA HISTORICA (2026-05-11): este Roadmap foi escrito em 2026-05-07 quando o plugin estava em v0.5.0 com 11 skills implementadas e ~58 skills previstas. **O plugin avancou MUITO ALEM** do roadmap original -- hoje (v2.38.1) tem **93 skills implementadas em 18 blocos completos + Skills Avancadas 2/2 (svg-engineering-ia + render-loop-svg) + 10 slash commands + 16 agentes totais = 119 artefatos**. As secoes abaixo sao preservadas como **historia do projeto**, mas refletem o plano inicial, NAO o estado atual. Para estado atual ver: `frank-mkt-plugin/skills/INDEX.md` (v2.38.1).
