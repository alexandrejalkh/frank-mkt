...
## Status (v0.6.0+ — 2026-05-08) — 🎉 SEO + Mídia Social + Comunicação Visual & IA COMPLETOS
...
| **Comunicação Visual & IA (NOVO bloco)** | ✅ **4/4** | 5.197 |
...
**Volatility:** 7 skills `medium` (re-validar a cada 6 meses) + 14 skills `high` com pesquisa de campo (re-validar a cada 3 meses — próxima validação 2026-08-07/08-08).
